...
cursor.execute('''INSERT INTO Movies (MovieName,Actor,Actress,Year,Director) VALUES ('Vikram', 'Kamal Haasan', '-', 2022,'Lokesh Kanagaraj' )''')
...
cursor.execute('''INSERT INTO Movies (MovieName,Actor,Actress,Year,Director)VALUES ('Don', 'Sivakarthikeyan', 'Priyanka Mohan', 2022,'Cibi Chakaravarthi' )''')
